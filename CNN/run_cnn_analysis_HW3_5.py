...
def run_all_cnn_analysis():
  ...
  layer1_filter_size_array = [5, 10, 15, 20] 
  layer1_depth_array = [8, 16, 32, 64]
  layer1_stride_array = [1, 2, 3, 4, 8] 
  layer2_filter_size_array = [5, 10, 15, 20] 
  layer2_depth_array = [8, 16, 32, 64]
  layer2_stride_array = [1, 2, 3, 4, 8]  
...
def save_to_mat(output_list,input_info):
  try:
    sio.savemat('cnn_5_results.mat', {'results': output_list,'inputs': input_info})
