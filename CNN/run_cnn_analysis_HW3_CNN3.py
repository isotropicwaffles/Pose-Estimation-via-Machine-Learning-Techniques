...
def run_all_cnn_analysis():
  ...
  # Add max pooling
  pooling_array = [False, True]
  layer1_pool_filter_size_array = [1, 2, 4, 8, 16, 32]
  layer1_pool_stride_array = [1, 2, 4,  8, 16, 32]
  layer2_pool_filter_size_array = [1, 2, 4,  8, 16, 32]
  layer2_pool_stride_array = [1, 2, 4, 8, 16, 32]
...
def save_to_mat(output_list,input_info):
  try:
    sio.savemat('cnn_3_results.mat', {'results': output_list,'inputs': input_info})
