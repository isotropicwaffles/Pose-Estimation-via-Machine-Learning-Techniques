...
def run_all_cnn_analysis():
  ...
  dropout_prob_array = np.linspace(.5,1,100) # set to < 1.0 to apply dropout, 1.0 to remove
...
def save_to_mat(output_list,input_info):
  try:
    sio.savemat('cnn_drop_out_results.mat', {'results': output_list,'inputs': input_info})
