...
from conv_mod_project_points import ArtistConvNet as AC
...
def run_all_cnn_analysis():
  ...
  num_conv_layers_array =[0] # [0,1,2,3]
  ...
  layer1_num_hidden_array = [64, 16, 32, 64, 128] 
  layer2_num_hidden_array = [64, 16, 32, 64, 128]
